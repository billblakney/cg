...
create text table lot (
   ...
   trigger_trade_id INT NOT NULL,
   buy_trade_id INT NOT NULL,
   sell_trade_id INT,
   ...
   FOREIGN KEY (buy_trade_id) REFERENCES trade(trade_id),
   FOREIGN KEY (sell_trade_id) REFERENCES trade(trade_id));
