...
/**
 * Converts a formatted text file into a Vector of objects.<br>
 * <br>
 *
 ...
 * <br>
 *
 * The file to be read can contain comment lines (which will not be converted to
 * objects). By default, comment lines are indicated by a "#" character in the
 * first position (after the line is "trimmed"). This criteria can be modified
 * by overriding the 'isCommentLine' method.
 */
public abstract class VectorFileReader extends Vector
{

   /**
    * Converts a line of text into an object. The format of the line and the
    * types of objects to be created are defined by the subclass that implements
    * this method. This method is called by the 'readVectorFile' method to
    * convert each non-comment line to an object.
    *
   ...
   /**
    * Converts and object to line of text. The format of the line of text should
    * be the same format expected by the 'convertLineToObj'. <i><b>This method
    * is used by the 'writeVectorFile" method, which is not yet
    * supported.</i></b>
    *
    * @param obj
    ...
    * before checking the first character.)<br>
    * <br>
    *
