...
import bbj.file.TextFileReader.LineConverter;
import util.*;

/**
 * Reads a trade file and returns a Vector of the trades.
 */
public class OldTradeLineConverter implements LineConverter<OldTrade>
{
   /**
    * Default constructor.
    */
   public OldTradeLineConverter()
   {
   }
    ...
    * 
    * @param aLine String The string to be converted.
    * @return The resulting Trade object.
    * @todo clean up note and instruction
    */
   @Override
   public OldTrade convertLine(String aLine)
   {
